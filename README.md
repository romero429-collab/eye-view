...
- **Inside** — Measured rooms when OpenStreetMap has them. Otherwise the real footprint. Volumes stay. Each one is painted with the satellite color under its footprint.
