...
export function LayerPanel({ value, onToggle, liveNote }: LayerPanelProps) {
  return (
    <div className="max-h-[min(48dvh,26rem)] max-w-[min(100%,18rem)] overflow-y-auto rounded-[var(--radius-md)] border border-border bg-surface p-1.5 shadow-[var(--shadow-panel)] md:max-w-56 md:p-2">
      <OverlayGroup
